...
const embedPopupHtmlCode = (chatflowid) => {
  return `<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/demo-c-agent-embedding/dist/web.js"
    Chatbot.init({
...
const embedPopupReactCode = (chatflowid) => {
  return `import { BubbleChat } from 'demo-c-agent-embedding-react'
...
const embedFullpageReactCode = (chatflowid) => {
  return `import { FullPageChat } from "demo-c-agent-embedding-react"
            ...
            <>
              <span>
                ...
                <p>
                  ...
                  <a rel='noreferrer' target='_blank' href='https://www.npmjs.com/package/demo-c-agent-embedding?activeTab=versions'>
                    version
                  </a>
                  :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/demo-c-agent-embedding@<version>/dist/web.js`}</code>
                </p>
              </span>
